...
import sa from "./PeopleItem.module.css";
...
/*        <>
        ...
        <div className={sa.people_item}>
            <div className={sa.people_item_content}>
                <NavLink to={"/profile/" + u.id}>
                    <img className={sa.people_item_img}
                         src={u.photos.small != null ? u.photos.small : userPhoto} alt=""/>
                </NavLink>
                <div className={sa.people_item_name}>
                    <span>{u.name}</span>
                ...
                {u.followed
                    ? <button
                        className={props.isFollowing.some(id => id === u.id)
                            ? sa.people_item_btn_disable
                            : sa.people_item_btn} onClick={(e) =>
